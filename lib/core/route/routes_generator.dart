...
import '../../features/tabs/presentaion/views/Account/contact_us.dart';
import '../../features/tabs/presentaion/views/Account/privacy_policy.dart';
import '../../features/tabs/presentaion/views/Account/terms_screen.dart';
    ...
    switch (settings.name) {
      case PageRouteName.circle1:
        return MaterialPageRoute(
          builder: (context) => const BackgroundScreen(child: Circle1()),
          settings: settings,
        );

      case PageRouteName.details:
        return MaterialPageRoute(
          builder: (context) => const BackgroundScreen(child: SahabaDetails()),
          settings: settings,
        );

      case PageRouteName.rwah:
        return MaterialPageRoute(
          builder: (context) => const BackgroundScreen(child: RwahScreen()),
          settings: settings,
        );
      case PageRouteName.tree:
        return MaterialPageRoute(
          builder: (context) => const BackgroundScreen(child: TreeScreen()),
          settings: settings,
        );
      case PageRouteName.homeScreen:
        return MaterialPageRoute(
          builder: (context) => const BackgroundScreen(child: HomeScreen()),
          settings: settings,
        );
      case PageRouteName.terms:
        return MaterialPageRoute(
          builder: (context) => const BackgroundScreen(child: TermsScreen()),
          settings: settings,
        );
      case PageRouteName.privacy:
        return MaterialPageRoute(
          builder: (context) => const BackgroundScreen(child: PrivacyScreen()),
          settings: settings,
        );
      ...
      case PageRouteName.profile:
        return MaterialPageRoute(
          builder: (context) => const BackgroundScreen(child: ProfileScreen()),
          settings: settings,
        );
      case PageRouteName.contact:
        return MaterialPageRoute(
          builder: (context) => const BackgroundScreen(child: ContactScreen()),
          settings: settings,
        );
      case PageRouteName.login:
        return MaterialPageRoute(
          builder: (context) => const BackgroundScreen(child: LoginScreen()),
          settings: settings,
        );
      case PageRouteName.register:
        return MaterialPageRoute(
          builder: (context) => const BackgroundScreen(child: RegisterScreen()),
          settings: settings,
        );
      case PageRouteName.verify_otp:
        return MaterialPageRoute(
          builder: (context) => const BackgroundScreen(child: VerifyOtp()),
          settings: settings,
        );
      case PageRouteName.forget_email:
        return MaterialPageRoute(
          builder: (context) => const BackgroundScreen(child: ForgetEmail()),
          settings: settings,
        );
      case PageRouteName.new_pass:
        return MaterialPageRoute(
          builder: (context) => const BackgroundScreen(child: NewPass()),
          settings: settings,
        );
      case PageRouteName.asaneed:
        return MaterialPageRoute(
          builder: (context) => const BackgroundScreen(child: AsaneedScreen()),
          settings: settings,
        );
      case PageRouteName.search:
        return MaterialPageRoute(
          builder: (context) => const BackgroundScreen(child: SearchScreen()),
          settings: settings,
        );
      ...
      default:
        return MaterialPageRoute(
          builder: (context) => const BackgroundScreen(child: OnBoarding()),
          settings: settings,
        );
    }
  }

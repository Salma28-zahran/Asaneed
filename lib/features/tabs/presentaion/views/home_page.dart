...
سواء كنت باحثًا مهتمًا بعلم الحديث أو مستخدمًا عاديًا يرغب في استكشاف الأسانيد، فإن "اسانيد" يقدم لك تجربة شاملة ومبسطة في عالم الإسناد.'''
          ...
          InkWell(
            onTap: () async {
              ...
              // ✅ لما يرجع من الصفحة، نشيل التحديد
              setState(() {
                isPressed = false;
              });
            },
...
//الكارت التاني
          InkWell(
            onTap: () async {
              ...
              await Navigator.pushNamed(context, PageRouteName.circle1);
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: Theme.of(context).brightness == Brightness.dark
                    ? (isPressed2 ? AppColor.primary : const Color(0xff2c2b2b))
                    : (isPressed2 ? AppColor.primary : AppColor.primary2),
                borderRadius: BorderRadius.circular(12),
                border: Border.all(color: AppColor.primary, width: 1.5),
              ),
              child: Row(
...
//الكارت التالت
          InkWell(
            onTap: () async {
              ...
              await Navigator.pushNamed(context, PageRouteName.tree);
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: Theme.of(context).brightness == Brightness.dark
                    ? (isTreePressed ? AppColor.primary : const Color(0xff2c2b2b))
                    : (isTreePressed ? AppColor.primary : AppColor.primary2),
                borderRadius: BorderRadius.circular(12),
                border: Border.all(color: AppColor.primary, width: 1.5),
              ),
              child: Row(

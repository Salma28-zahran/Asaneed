...
class Highlight {
  ...
  Highlight({required this.text, required this.onTap});
}
...
class Hadith {
  ...
  Hadith({required this.mainText, required this.highlights});
}


// هنا تحطي كل الأحاديث والهايلايتس
List<Hadith> hadiths = [
  Hadith(
    mainText:
        "بابِ حَدَثنا عَلَى بِن عَبْد اللّٰه حَدَثنا سُفْيان حَدَثنا اِبْن المنكدر قالَ سَمِعْتُ جابِر بِن عَبْد اللّٰه رَضِيَ اللّٰه عَنهُما قالَ جِي بِأَبِي يَوْمَ أَحَدُ قَد مِثْلَ بِهِ حَتَّى وَضْعِ بَيِّنَ يَدَيْ رَسُولُ اللّٰه صَلَّى اللّٰه عَلَيهِ وَسَلَّمَ وَقَد سَجَّى ثَوْبا فَذَهَبَت أُرِيد أَنَّ أَكْشِف عَنهُ فَنَهانِي قَوْمِيٌّ ثُمَّ ذَهَبْتُ أَكْشِف عَنهُ فَنَهانِي قَوْمِيٌّ فَأَمَرّ رَسُولُ اللّٰه صَلَّى اللّٰه عَلَيهِ وَسَلَّمَ فَرَفَعَ فَسَمِعَ صَوْتٍ صائِحه فَقالَ مِن هٰذِهِ فَقالُوا اِبْنَةُ عَمْرو أَو أُخْت عَمْرو قالَ فَلَم تَبْكَى أَو لا تَبْكَى فَما زالَت المَلائِكَةِ تَظَلّه بِأَجْنِحَتها حَتَّى رَفْعِ",
    highlights: [
      Highlight(
        text: "(عَلَى بِن عَبْد اللّٰه)",
        onTap: (BuildContext context) {
          Navigator.pushNamed(context, PageRouteName.details);
          // أي حاجة تحبيها عند الضغط على الاسم
  ...
  Hadith(
    mainText:
    "حَدَثَنِي يَحْيَى بِن بَكِير وَ حَدَثَنِي سَعِيد بِن مَرْوان …",
    highlights: [
      Highlight(
        text: "(يَحْيَى بِن بَكِير)",
        onTap: () {
          print("Pressed يحيى بن بكير");
        },
      ),
      Highlight(
        text: "(سَعِيد بِن مَرْوان)",
        onTap: () {
          print("Pressed سعيد بن مرّوان");
        },
      ),
    ],
  ),
